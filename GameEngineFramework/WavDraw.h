...
typedef struct {
	...
	unsigned int WavSize;	// Size of the wav portion of the file
	...
	unsigned short BitDepth;		// Numbers of bits per sample

	// Data
	char DataHeader[4];		// Contains "data"
	unsigned int DataBytes;	// Number of bytes in data. Number of samples * num_channles * sample byte size
} WAVHeader;
